    ...
    <div id="MainNav" class="fixed z-50 w-full flex items-center justify-between h-[56px] bg-white shadow-xl border-b">
        <div id="NavLeft" class="flex items-center justify-start w-[260px]">
            ...
            <div class="flex items-center justify-center bg-[#EFF2F5] p-1 rounded-full h-[40px] ml-2">
                <Magnify class="p-1" :size="22" fill-color="#64676B" />
                <input class="lg:block hidden border-none p-0 bg-[#EFF2F5] ring-0 focus:ring-0" type="text" placeholder="Search Facebook" />
            </div>
        </div>
        ...
        <div id="NavCenter" class="hidden lg:flex items-center ml-5 justify-center w-8/12 max-w-[600px]">
            <Link href="/" class="w-full">
                <div :class="$page.url === '/' ? 'mt-1.5' : ''" class="flex items-center justify-center h-[48px] p-1 hover:bg-[#F2F2F2] w-full rounded-lg cursor-pointer">
                    <div>
                        <Home v-if="$page.url === '/'" class="mx-auto" :size="27" fill-color="#1A73E3" />
                        <HomeOutline v-else class="mx-auto" :size="32" fill-color="#64676B" />
                    </div>
                </div>
            ...
            <button class="flex items-center justify-center h-[48px] p-1 hover:bg-[#F2F2F2] w-full rounded-lg mx-1 cursor-pointer">
                <TelevisionPlay class="mx-auto" :size="27" fill-color="#64676B" />
            </button>
            <button class="flex items-center justify-center h-[48px] p-1 hover:bg-[#F2F2F2] w-full rounded-lg mx-1 cursor-pointer">
                <StorefrontOutline class="mx-auto" :size="27" fill-color="#64676B" />
            </button>
            <button class="flex items-center justify-center h-[48px] p-1 hover:bg-[#F2F2F2] w-full rounded-lg mx-1 cursor-pointer">
                <span class="rounded-full border-[2px] border-[#64676B]">
                    <AccountGroup class="mx-auto" :size="22" fill-color="#64676B" />
                </span>
            </button>
            <button class="flex items-center justify-center h-[48px] p-1 hover:bg-[#F2F2F2] w-full rounded-lg mx-1 cursor-pointer">
                <ControllerClassicOutline class="mx-auto" :size="32" fill-color="#64676B" />
            </button>
        </div>
        ...
        <div class="flex items-center justify-end w-2/12 mr-4">
            <button class="rounded-full bg-[#E3E6EA] p-2 hover:bg-gray-300 mx-1 cursor-pointer">
                <DotsGrid class="mx-auto" :size="23" fill-color="#050505" />
            </button>
            <button class="rounded-full bg-[#E3E6EA] p-2 hover:bg-gray-300 mx-1 cursor-pointer">
                <FacebookMessenger class="mx-auto" :size="23" fill-color="#050505" />
            </button>
            <button class="rounded-full bg-[#E3E6EA] p-2 hover:bg-gray-300 mx-1 cursor-pointer">
                <Bell class="mx-auto" :size="23" fill-color="#050505" />
            </button>
            <div class="flex items-center justify-center relative">
                <button @click="showMenu = !showMenu">
                    <img alt="" class="rounded-full ml-1 min-w-[40px] max-h-[40px] cursor-pointer" src="https://picsum.photos/id/10/300/320" />
                </button>
                ...
                <div v-if="showMenu" class="absolute bg-white shadow-xl top-10 right-0 w-[330px] rounded-lg p-1 border mt-1">
                    <Link href="/" @click="showMenu = !showMenu">
                        <div class="flex items-center gap-3 hover:bg-gray-200 p-2 rounded-lg">
                            <img alt="" class="rounded-full ml-1 min-w-[35px] max-h-[35px] cursor-pointer" src="https://picsum.photos/id/10/300/320" />
                            <span>Ayman Alhattami</span>
                        </div>
                    </Link>
